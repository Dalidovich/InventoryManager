...
namespace InventoryManager.DAL.Migrations
{
    ...
    [Migration("20250812140030_createLinkToMasterField")]
    partial class createLinkToMasterField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManager.Domain.Entities.ObjectField", b =>
                {
                    ...
                    b.HasOne("InventoryManager.Domain.Entities.ObjectField", "MasterField")
                        .WithMany()
                        .HasForeignKey("MasterFieldId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("Creator");

                    b.Navigation("MasterField");
                });
